...
public class MemberDto {
    ...
    private Set<CourseDto> teachingCourses;
    ...
    public Set<CourseDto> getTeachingCourses() {
        return teachingCourses;
    }

    public void setTeachingCourses(Set<CourseDto> teachingCourses) {
        this.teachingCourses = teachingCourses;
    }
    ...
    public static MemberDto from(Member member) {
        ...
        Set<CourseDto> teachingCourses = member.getTeachingCourses().stream().map(CourseDto::from).collect(Collectors.toSet());
        return new MemberDto(member.getMemberId(), member.getLoginId(), authorityDtoSet, null, member.getName(), member.getBirthDate().toString(), 
                member.getGender().name(), member.getNationality().name(), member.getEmail(), member.getPhoneNum(), member.getJoinDate(), teachingCourses);
    }
    ...
    public Member toMember() {
        ...
        member.setTeachingCourses(this.teachingCourses.stream().map(CourseDto::toCourse).collect(Collectors.toSet()));
        return member;
    }
}
