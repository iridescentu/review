...
public class TodoListController {
    ...
    @GetMapping("/todolist/member/{memberId}")
    ...
    @GetMapping("/todolist/priority/{priority}")
    ...
    @GetMapping("/todolist/completed/{isCompleted}")
    ...
    @GetMapping("/todolist/due/{currentDate}")
    ...
    @GetMapping("/todolist/completeddate/{completionDate}")
    ...
    @GetMapping("/todolist/member/{memberId}/priority/{priority}/completed/{isCompleted}")
