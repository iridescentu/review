...
//	
//	@Override
//	public ResponseDto<ExamHistoryDto> getExamHistory(Long id) {
//	    try {
//	        ExamHistory examHistory = examHistoryRepository.findById(id)
...
//	        
//	        examHistory.setMember(examHistoryDto.getMember().toMember());
//	        examHistory.setExam(examHistoryDto.getExam().toExam());
